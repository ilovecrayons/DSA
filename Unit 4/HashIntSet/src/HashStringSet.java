// (IDENTICAL TO HashStringSet.java but without equals method)
// A HashStringSet object represents a set of integers using a hash table
...
public class HashStringSet {
	...
	// this set.
	public boolean __equals(Object o) {
	...
	// YOUR CODE GOES HERE
	// public void addAll(HashStringSet other) {
	// 	for (Node n : other.elementData) {
	// 		Node crt = n;
	// 		while(crt != null){
	// 			this.add(crt.data);
	// 			crt = crt.next;
	...
	// public boolean containsAll(HashStringSet other){
	// 	for(Node n : other.elementData){
	// 		Node crt = n;
	// 		while(crt != null){
	// 			if(!this.contains(crt.data)) return false;
	// 			crt = crt.next;
	// 		}
	// 	}
	// 	return true;
	...
	// public void removeAll(HashStringSet other){
	// 	for(Node n : other.elementData){
	// 		Node crt = n;
	// 		while(crt != null){
	// 			this.remove(crt.data);
	// 			crt = crt.next;
	// 		}
	// 	}
	// }
